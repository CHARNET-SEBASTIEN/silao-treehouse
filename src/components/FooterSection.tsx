        ...
        <div className="relative z-10 mx-auto max-w-6xl px-6 pb-8 pt-12">
          ...
          <div className="flex flex-col items-center justify-between gap-4 border-t border-border pt-6 sm:flex-row">
            ...
            <div className="flex flex-wrap gap-4 text-xs text-muted-foreground">
              ...
              <Link to="/recrutement" className="rounded-md transition-colors hover:text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2">
                Recrutement
              </Link>
              ...
              <Link to="/supervision-esante" className="rounded-md transition-colors hover:text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2">
                Supervision e-santé
              </Link>
