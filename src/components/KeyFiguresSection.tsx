      ...
      >
        {figures.map((figure) => (
          <motion.article
            ...
            className="lift-on-hover relative overflow-hidden rounded-[1.5rem] border border-border/70 bg-card px-5 py-6 text-center shadow-sm hover:border-primary/30 hover:shadow-[0_28px_60px_-32px_hsl(var(--brand-violet)/0.32)]"
          >
            <div className="absolute inset-x-0 top-0 h-1 bg-[linear-gradient(90deg,hsl(var(--primary)),hsl(var(--accent)))]" />
            <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-primary/10 text-primary transition-transform duration-300 hover:scale-105">
              <figure.icon className="h-6 w-6" />
            </div>
            <p className="text-4xl font-extrabold tracking-tight text-brand-violet text-foreground">
